...
// To test dd-trace-go changes, paste the the following line in this file. Go should auto update the paths for you
// replace gopkg.in/DataDog/dd-trace-go.v1 => github.com/DataDog/dd-trace-go <your branch name in dd-trace-go>
